...
> На экземпляре с маркировкой F401CC/DEV_ID0x431: 22/22 HW PASS после удаления
> дублей setup/loop, с отдельным identity override; [результаты и границы доверия](F401_MARKING_EXPERIMENT.md).
> Проверка стандартного F401CC с DEV_ID0x423 ещё ожидается.
