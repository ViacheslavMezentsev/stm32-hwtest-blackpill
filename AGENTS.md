...
- h503 — планируемый профиль, не добавлен в CMake/YAML. До реализации уточнить полный part number/память/IOC и backend. Не переносить ADC-калибровку 30/110°C F411 на H503; не приписывать H503 TrustZone по аналогии с H563.
