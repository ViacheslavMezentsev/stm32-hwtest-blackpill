...
Позднее полный ST набор прошёл непрерывно22/22; отдельная серия воспроизвела
USB-сбой уже через OpenOCD. [Продолжение исследования](F429_SERVER_STABILITY.md).
Ниже сохранена последовательность первоначального опыта.
