...
- MCU-профили: profiles/f411 и profiles/f103; выбор STM32_YML_PROFILE. CubeMX генерирует код внутри соответствующего каталога. Для нового MCU использовать отдельный build; F103 уже собирается, но аппаратно не проверен и прикладной User пока не подключён.
