...
Сборка и offline-проверки выполнены; аппаратная проверка ещё не проводилась.
...
После подтверждения владельца: DISCO + встроенный ST-Link/V2, SWD, backend OpenOCD.
