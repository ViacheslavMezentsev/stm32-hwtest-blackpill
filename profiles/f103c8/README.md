...
IOC и сгенерированный код добавлены: `profiles/f103c8/stm32-hwtest-bluepill.ioc`.
...
После генерации: `cmake --preset f103c8-debug`, `cmake --build --preset f103c8-debug`.
...
ctest --preset f103c8-hw
```

Отчёт: `build/f103c8-debug-hwtest/hwtest/ctest-junit.xml`.
